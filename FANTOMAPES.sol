...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1910000 * (10**9); // user must hold 1,910,000 token
    ...
    LockToken
{
    ...
    function setFees(
        ...
        require(totalFee <= feeDenominator / 3, "Invalid Fee");
    }
